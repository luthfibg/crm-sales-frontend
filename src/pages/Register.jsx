...
const Register = () => {
    ...
    const handleOnclickSave = async e => {
        ...
        try {
            await axios.post("http://localhost:2999/data/salesmen", sales);
    ...
    return (
        ...
        autoComplete="off">
            ...
            <div>
                ...
                label="Nama Depan"
                />
                <TextField onChange={handleChange} name="lastname"
                id="outlined-lastname"
                label="Nama Belakang"
                />
                <TextField onChange={handleChange} name="fullname"
                ...
                type="password"
                />
                <TextField onChange={handleChange} name="address"
                id="outlined-address"
                label="Alamat"
                multiline
                rows={3}
                helperText="Alamat saat ini"
                />
                <TextField onChange={handleChange} name="bio"
                id="outlined-bio"
                label="Bio"
                multiline
                rows={3}
